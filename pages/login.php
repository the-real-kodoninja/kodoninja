...
<div class="min-h-screen flex items-center justify-center">
    <div class="max-w-md w-full space-y-8 p-6">
        ...
        <form class="space-y-6" action="/?page=login" method="POST">
            ...
            <div>
                <button type="submit" class="w-full py-2 px-4 bg-gray-600 text-white rounded-md hover:bg-gray-500 focus:outline-none focus:ring-2 focus:ring-gray-500">Sign In</button>
            </div>
        </form>
