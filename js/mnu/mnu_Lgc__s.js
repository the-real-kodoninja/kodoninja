// // v panel module holds all logic 
// function vPnlMod() {
...
//             <textarea id="opTxt" style="margin: 10px 0px 0px;" placeholder="Please explain exactly why your reporting this `+cnt+`"></textarea>
//         </div>
//         `;
//         vPnlMain.innerHTML = vSel_op1;
//     };
//     if (opt == "report" && res == "NULL") {
//         vPnlHdr.innerHTML = "Looks like you want to "+opt+" this "+cnt+" <span class=\"vPnlClx fR\" onclick=\"vPnlMod()\">(X)</span>";
//         vPnlBdy.innerHTML = vBtnPnl;
//         vPnlRpt_optns();
...
//         var ajax = ajaxObj("POST", "prs/mnu/mnu_Lgc_RePrt_x.php");
...
//         } 
//         if (res == "yes") {
//             var ajax = ajaxObj("POST", "prs/mnu/mnu_Lgc_eVal_x.php");
//             ajax.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
//             ajax.onreadystatechange = function() { 
//                 if(ajax.readyState == 4 && ajax.status == 200) { 
//                     var return_data = ajax.responseText; 
...
//                             url = document.location = "view.php?t="+newLoc+"p="+cid;
